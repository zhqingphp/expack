## 创建机器人[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1834485311)
...
4. 如果上一步执行成功那么botfather会返回该机器人的token，大概长这样
   ...
   ```makefile
   Copy123456789:ABCDEfghiJK4314daDSadSa7
   ```

   记住这个token,到这里机器人就创建好了

## 将机器人添加到群组里[#](https://www.cnblogs.com/kainhuck/p/13576012.html#2162747265)

进入机器人信息页面，点击`更多`，点击`添加到群组`，选择一个群组即可

## 获取群组chat_id[#](https://www.cnblogs.com/kainhuck/p/13576012.html#704352966)
...
```bash
Copyhttps://api.telegram.org/bot<token>/getUpdates
```
...
## 机器人发送请求[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3710834974)

### 请求接口[#](https://www.cnblogs.com/kainhuck/p/13576012.html#467137858)

telegram发送消息的方式类似与钉钉机器人，都是向一个api发送http请求，而且对于同一个API`telegram`支持`GET`和`POST`两种请求方式.请求的api格式如下

```xml
Copyhttps://api.telegram.org/bot<token>/<method>
```

其中token为你的机器人token，method为telegram给定的方法，在获取群组chat_id那一步就使用了telegram的其中一个方法(getUpdates),其他方法后面会介绍

### 携带参数[#](https://www.cnblogs.com/kainhuck/p/13576012.html#817489729)
...
### 获取响应[#](https://www.cnblogs.com/kainhuck/p/13576012.html#737609736)
...
## telegram对象[#](https://www.cnblogs.com/kainhuck/p/13576012.html#2162075366)

telegram机器人的几乎所有操作都是一个一个对象的操作。

telegram定义了许多场景下的对象，[详见](https://core.telegram.org/bots/api#available-types)，这里举例一些常见的

### Update[#](https://www.cnblogs.com/kainhuck/p/13576012.html#514067777)
...
### User[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1816865463)
...
### Chat[#](https://www.cnblogs.com/kainhuck/p/13576012.html#447900379)
...
### Message[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1934584274)
...
### MessageEntity[#](https://www.cnblogs.com/kainhuck/p/13576012.html#4264247128)
...
### BotCommand[#](https://www.cnblogs.com/kainhuck/p/13576012.html#752773174)
...
### WebhookInfo[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1753172545)
...
### ReplyKeyboardMarkup[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3914242403)
...
### KeyboardButton[#](https://www.cnblogs.com/kainhuck/p/13576012.html#2173084659)
...
### KeyboardButtonPollType[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3363249333)
...
### ReplyKeyboardRemove[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1721947502)
...
### InlineKeyboardMarkup[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3760513332)
...
### InlineKeyboardButton[#](https://www.cnblogs.com/kainhuck/p/13576012.html#514241765)
...
| switch_inline_query              | String                                                       | 可选的。如果已设置，则按下按钮将提示用户选择其聊天之一，打开该聊天并将bot的用户名和指定的内联查询插入输入字段。可以为空，在这种情况下，只会插入机器人的用户名。 **注意**：这为用户提供了一种简便的方法，使他们在当前与它进行私聊时以内联模式开始使用您的机器人。与switch_pm…操作结合使用时特别有用–在这种情况下，用户将自动返回到其切换到的聊天中，而跳过聊天选择屏幕。 |
...
### ForceReply[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3184809572)
...
## telegram方法[#](https://www.cnblogs.com/kainhuck/p/13576012.html#4031495383)
...
### getUpdates[#](https://www.cnblogs.com/kainhuck/p/13576012.html#841350626)
...
### setWebhook[#](https://www.cnblogs.com/kainhuck/p/13576012.html#2264801278)
...
### deleteWebhook[#](https://www.cnblogs.com/kainhuck/p/13576012.html#2695685597)
...
### getWebhookInfo[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3862233287)
...
### getMe[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1959450775)
...
### getChat[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3872354583)
...
### sendMessage[#](https://www.cnblogs.com/kainhuck/p/13576012.html#2362047082)
...
### setMyCommands[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3524833304)
...
### getMyCommands[#](https://www.cnblogs.com/kainhuck/p/13576012.html#4033157896)
...
## 格式化选项[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1458812242)
...
### MarkdownV2 style[#](https://www.cnblogs.com/kainhuck/p/13576012.html#690204190)
...
### HTML style[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1565723978)

要使用此模式，请在parse_mode字段中传递HTML。当前支持以下标签：

```html
Copy<b>bold</b>, <strong>bold</strong>
...
### Markdown style[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3907399416)
...
## telegram中的命令[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3091649595)

通过命令来和机器人交互是电报机器人的一大特色，在telegram中命令由实体`BotCommand`表示（telegram对象那节已经介绍过）。

其实任何以`/`开头的连续英文消息都被视作命令(可以理解为这是一种具有格式的普通消息)，私聊或者在群里@机器人时发送`/`开头的信息可以查看实体类型为`bot_command`。要想让机器人收到某条命令后执行响应动作只需要判断发送的消息是否匹配我们约定的内容即刻，（从某种意义上讲无论发送的消息是否是命令格式我们都可以将其视为命令只要我们愿意），开发具有命令响应的过程总结如下：
...
### 给机器人注册指令[#](https://www.cnblogs.com/kainhuck/p/13576012.html#4078294466)
...
### 查看已注册的指令[#](https://www.cnblogs.com/kainhuck/p/13576012.html#1976132111)

- 详见（telegram方法 getMyCommands）

### 基本指令[#](https://www.cnblogs.com/kainhuck/p/13576012.html#831690294)
...
## 键盘[#](https://www.cnblogs.com/kainhuck/p/13576012.html#3655576038)
...
### 创建键盘[#](https://www.cnblogs.com/kainhuck/p/13576012.html#774675687)
